...
function SubCategory() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8081/getallsubcategory")
      .then((res) => {
  ...
  function handleDelete() {
    axios
      .post("http://localhost:8081/subcategorydelete/" + deleteid)
      .then((res) => {
      ...
      <div className="main-wrapper">
        ...
        <div className="page-wrapper">
          <div className="content">
            <h4 className="page-title">Sub-category List</h4>
            <div className="card">
                  ...
                  <CTableBody>
                    {currentUsers.map((data, index) => (
                      <CTableRow key={index}>
                        ...
                        <CTableDataCell>{data.category_name}</CTableDataCell>
                        <CTableDataCell>
                          ...
                          <CCollapse visible={details.includes(data.id)}>
                            <CCardBody>
                              ...
                              <CButton color="info" size="sm">
                                <Link to={`/SubCategoryUpdate/${data.id}`}>
                                  Edit
                                </Link>
                              </CButton>
