      ...
      <div className="main-wrapper">
        ...
        <div className="page-wrapper">
          <div className="content">
            <h4 className="page-title">Deliveryman List</h4>
            <div className="card">
              <div className="card-header">
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    />
                    <div>
                      <Link to="/AddDeliveryman" className="btn btn-primary">
                          ...
                          <CCollapse visible={details.includes(data.id)}>
                            <CCardBody>
                              ...
                              <CButton color="info" size="sm">
                                <Link to={`/DeliverymanUpdate/${data.id}`}>Edit</Link>
                              </CButton>
            ...
            <div className="modal-content">
              <div className="modal-body">
                <div className="text-center">
                  <h4 className="mb-2">Remove Delivery man?</h4>
                  <p className="mb-0">
                    Are you sure you want to remove the selected delivery man?
                  </p>
